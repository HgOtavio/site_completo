...
@media (max-width: 768px) {
    /* Ajustes para elementos */
    .container {
        width: 90%;
        padding: 15px;
    }
    /* Exemplo de ajuste de fontes */
    h1, h2, h3 {
        font-size: 1.5em;
    }
    /* Exemplo para layout flex */
    .flex-container {
        flex-direction: column;
    }
}
...
@media (max-width: 480px) {
    ...
    /* Exemplo para centralizar texto */
    .header, .footer {
        text-align: center;
    }
    .img_fim {
    ...
    <div id="localizacao_des">
        ...
        <div class="produtos_des">
            ...
            <div class="parte_baixo">
                ...
                <a href="http://localhost/trbalho_Eli/php/maquinas.php" class="link_des">Saiba Mais <img src="favicon/pngwing.com.png" alt="seta" class="setas"></a> <!--link maquinas, cima-->
            </div>
        </div>
        <!--Part2-->
        <div class="produtos_des">
            <a href="http://localhost/trbalho_Eli/php/maquinas.php"><img src="favicon\Gemini_Generated_Image_i015xli015xli015-removebg-preview.png" alt="Produto" class="img_des"></a><!--link maquinas, baixo-->
            <div class="parte_baixo">
                <h2 class="nome_des">Treino Cardiovascular</h2>
                <a href="pgteste/maisprodutos.html" class="link_des">Saiba Mais <img src="favicon/pngwing.com.png" alt="seta" class="setas"></a>
            </div>
        </div>
    </div>
</div>
...
<div id="m_vendidos">
    ...
    <div id="sepa_mv">
        ...
        <div class="produtos_mv">
            ...
            <a href="maquinas.php" class="link_mv"><!--link maquinas, produto-->
...
<div id="email">
    ...
    <div id="emial_n">
        ...
        <button type="submit" id="but_enciar_e"><a href="homesite02.php">Enviar</a></button>
    </div>
</div>
<!--Suporte-->
<div id="suporte">
